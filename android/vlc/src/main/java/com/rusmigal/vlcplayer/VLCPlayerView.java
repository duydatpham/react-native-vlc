...
TextureView.SurfaceTextureListener, LifecycleEventListener, MediaPlayer.EventListener {
	...
	mSurface.setZOrderOnTop(true);
        holder.addCallback(new SurfaceHolder.Callback() {
			...
			public void surfaceChanged(SurfaceHolder holder, int format, int width, int height) {
				// Toast.makeText(getContext(), "surfaceChanged::SurfaceHolder " + width + "::" + height, Toast.LENGTH_SHORT).show();
			}
		});
    ...
    public void surfaceChanged(SurfaceHolder holder, int format, int width,
            int height) {
              // Toast.makeText(getContext(), "surfaceChanged " + width + "::" + height, Toast.LENGTH_SHORT).show();
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i, int i2) {
      // Toast.makeText(getContext(), "onSurfaceTextureAvailable " , Toast.LENGTH_SHORT).show();
    }

    @Override
    public void onSurfaceTextureSizeChanged(SurfaceTexture surfaceTexture, int width, int height) {
      // Toast.makeText(getContext(), "onSurfaceTextureSizeChanged " + width + "::" + height, Toast.LENGTH_SHORT).show();
    }

    @Override
    public boolean onSurfaceTextureDestroyed(SurfaceTexture surfaceTexture) {
        // Toast.makeText(getContext(), "onSurfaceTextureDestroyed " , Toast.LENGTH_SHORT).show();
        return true;
    }
...
// Toast.makeText(getContext(), "finalWidth " + finalWidth + "::" + height, Toast.LENGTH_SHORT).show();
    ...
    public void onNewLayout(IVLCVout vout, int width, int height, int visibleWidth, int visibleHeight, int sarNum, int sarDen) {
        ...
        // Toast.makeText(getContext(), "onNewLayout " + width + "::" + height, Toast.LENGTH_SHORT).show();
    }
