...
public class VLCPlayerViewManager extends ViewGroupManager<VLCPlayerView> {
    ...
    private static VLCPlayerViewManager ourInstance;

    public VLCPlayerView vlcView;


    public static VLCPlayerViewManager getInstance() {
        return ourInstance;
    }

    public static VLCPlayerViewManager newInstance() {
        ourInstance = new VLCPlayerViewManager();
        return ourInstance;
    }
    ...
    protected VLCPlayerView createViewInstance(ThemedReactContext reactContext) {
        vlcView = new VLCPlayerView(reactContext);
        return vlcView;
    }
